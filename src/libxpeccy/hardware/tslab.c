...
Z80EX_BYTE tsInFE(ZXComp* comp, Z80EX_WORD port) {
...
Z80EX_BYTE tsInFFFD(ZXComp* comp, Z80EX_WORD port) {
...
Z80EX_BYTE tsInMice(ZXComp* comp, Z80EX_WORD port) {
	comp->mouse->used = 1;
...
void tsOutBFFD(ZXComp* comp, Z80EX_WORD port, Z80EX_BYTE val) {
	tsOut(comp->ts, 0xbffd, val);
}

void tsOutFFFD(ZXComp* comp, Z80EX_WORD port, Z80EX_BYTE val) {
...
xPort tsPortMap[] = {
	...
	// !dos
	{0x00f7,0x00fe,1,0,&tsInFE,	&tsOutFE},	// fe
	...
	{0xc0ff,0xbffd,1,0,NULL,	&tsOutBFFD},	// bffd
	{0xc0ff,0xfffd,1,0,&tsInFFFD,	&tsOutFFFD},	// fffd
	{0xffff,0xfadf,1,0,&tsInMice,	NULL},		// fadf
	{0xffff,0xfbdf,1,0,&tsInMice,	NULL},		// fbdf
	{0xffff,0xffdf,1,0,&tsInMice,	NULL},		// ffdf
	// dos
