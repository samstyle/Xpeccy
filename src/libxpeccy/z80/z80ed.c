...
opCode edTab[256]={
	...
	{0,4,4,0,0,0,0,&ed40,NULL,"in b,(c)"},
	{0,4,4,0,0,0,0,&ed41,NULL,"out (c),b"},
	{0,11,0,0,0,0,0,&ed42,NULL,"sbc hl,bc"},
	{0,4,3,3,3,3,0,&ed43,NULL,"ld (:2),bc"},
	{0,4,0,0,0,0,0,&ed44,NULL,"neg"},
	{0,4,3,3,0,0,0,&ed45,NULL,"retn"},
	{0,4,0,0,0,0,0,&ed46,NULL,"im 0"},
	{0,5,0,0,0,0,0,&ed47,NULL,"ld i,a"},

	{0,4,4,0,0,0,0,&ed48,NULL,"in c,(c)"},
	{0,4,4,0,0,0,0,&ed49,NULL,"out (c),c"},
	{0,11,0,0,0,0,0,&ed4A,NULL,"adc hl,bc"},
	{0,4,3,3,3,3,0,&ed4B,NULL,"ld bc,(:2)"},
	{0,4,0,0,0,0,0,&ed44,NULL,"neg *"},
	{0,4,3,3,0,0,0,&ed4D,NULL,"reti"},
	{0,4,0,0,0,0,0,&ed46,NULL,"im 0 *"},
	{0,5,0,0,0,0,0,&ed4F,NULL,"ld r,a"},

	{0,4,4,0,0,0,0,&ed50,NULL,"in d,(c)"},
	{0,4,4,0,0,0,0,&ed51,NULL,"out (c),d"},
	{0,11,0,0,0,0,0,&ed52,NULL,"sbc hl,de"},
	{0,4,3,3,3,3,0,&ed53,NULL,"ld (:2),de"},
	{0,4,0,0,0,0,0,&ed44,NULL,"neg *"},
	{0,4,3,3,0,0,0,&ed45,NULL,"retn *"},
	{0,4,0,0,0,0,0,&ed56,NULL,"im 1"},
	{0,5,0,0,0,0,0,&ed57,NULL,"ld a,i"},

	{0,4,4,0,0,0,0,&ed58,NULL,"in e,(c)"},
	{0,4,4,0,0,0,0,&ed59,NULL,"out (c),e"},
	{0,11,0,0,0,0,0,&ed5A,NULL,"adc hl,de"},
	{0,4,3,3,3,3,0,&ed5B,NULL,"ld de,(:2)"},
	{0,4,0,0,0,0,0,&ed44,NULL,"neg *"},
	{0,4,3,3,0,0,0,&ed4D,NULL,"reti *"},
	{0,4,0,0,0,0,0,&ed5E,NULL,"im 2"},
	{0,5,0,0,0,0,0,&ed5F,NULL,"ld a,r"},

	{0,4,4,0,0,0,0,&ed60,NULL,"in h,(c)"},
	{0,4,4,0,0,0,0,&ed61,NULL,"out (c),h"},
	{0,11,0,0,0,0,0,&ed62,NULL,"sbc hl,hl"},
	{0,4,3,3,3,3,0,&npr22,NULL,"ld (:2),hl"},
	{0,4,0,0,0,0,0,&ed44,NULL,"neg *"},
	{0,4,3,3,0,0,0,&ed45,NULL,"retn *"},
	{0,4,0,0,0,0,0,&ed46,NULL,"im 0 *"},
	{0,4,3,4,3,0,0,&ed67,NULL,"rrd"},

	{0,4,4,0,0,0,0,&ed68,NULL,"in l,(c)"},
	{0,4,4,0,0,0,0,&ed69,NULL,"out (c),l"},
	{0,11,0,0,0,0,0,&ed6A,NULL,"adc hl,hl"},
	{0,4,3,3,3,3,0,&npr2A,NULL,"ld hl,(:2)"},
	{0,4,0,0,0,0,0,&ed44,NULL,"neg *"},
	{0,4,3,3,0,0,0,&ed4D,NULL,"reti *"},
	{0,4,0,0,0,0,0,&ed46,NULL,"im 0 *"},
	{0,4,3,4,3,0,0,&ed6F,NULL,"rld"},

	{0,4,4,0,0,0,0,&ed70,NULL,"in (c)"},
	{0,4,4,0,0,0,0,&ed71,NULL,"out (c),0"},
	{0,11,0,0,0,0,0,&ed72,NULL,"sbc hl,sp"},
	{0,4,3,3,3,3,0,&ed73,NULL,"ld (:2),sp"},
	{0,4,0,0,0,0,0,&ed44,NULL,"neg *"},
	{0,4,3,3,0,0,0,&ed45,NULL,"retn *"},
	{0,4,0,0,0,0,0,&ed56,NULL,"im 1 *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},

	{0,4,4,0,0,0,0,&ed78,NULL,"in a,(c)"},
	{0,4,4,0,0,0,0,&ed79,NULL,"out (c),a"},
	{0,11,0,0,0,0,0,&ed7A,NULL,"adc hl,sp"},
	{0,4,3,3,3,3,0,&ed7B,NULL,"ld sp,(:2)"},
	{0,4,0,0,0,0,0,&ed44,NULL,"neg *"},
	{0,4,3,3,0,0,0,&ed4D,NULL,"reti *"},
	{0,4,0,0,0,0,0,&ed5E,NULL,"im 2 *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	...
	{0,4,3,5,0,0,0,&edA0,NULL,"ldi"},
	{0,4,3,5,0,0,0,&edA1,NULL,"cpi"},
	{0,5,4,3,0,0,0,&edA2,NULL,"ini"},
	{0,5,3,4,0,0,0,&edA3,NULL,"outi"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},

	{0,4,3,5,0,0,0,&edA8,NULL,"ldd"},
	{0,4,3,5,0,0,0,&edA9,NULL,"cpd"},
	{0,5,4,3,0,0,0,&edAA,NULL,"ind"},
	{0,5,3,4,0,0,0,&edAB,NULL,"outd"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},

	{0,4,3,5,5,0,0,&edB0,NULL,"ldir"},
	{0,4,3,5,5,0,0,&edB1,NULL,"cpir"},
	{0,5,3,3,5,0,0,&edB2,NULL,"inir"},
	{0,5,3,4,5,0,0,&edB3,NULL,"otir"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},

	{0,4,3,5,5,0,0,&edB8,NULL,"lddr"},
	{0,4,3,5,5,0,0,&edB9,NULL,"cpdr"},
	{0,5,4,3,5,0,0,&edBA,NULL,"indr"},
	{0,5,3,4,5,0,0,&edBB,NULL,"otdr"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
	{0,4,0,0,0,0,0,&npr00,NULL,"nop *"},
