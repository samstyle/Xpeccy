...
opCode ddTab[256]={
	...
	{0,11,0,0,0,0,&dd09,NULL,"add ix,bc"},
	...
	{0,11,0,0,0,0,&dd19,NULL,"add ix,de"},
	...
	{0,4,3,3,0,0,&dd21,NULL,"ld ix,:2"},
	{0,4,3,3,3,3,&dd22,NULL,"ld (:2),ix"},		// 4,3rd,3rd,3wr,3wr
	{0,6,0,0,0,0,&dd23,NULL,"inc ix"},
	{0,4,0,0,0,0,&dd24,NULL,"inc hx"},
	{0,4,0,0,0,0,&dd25,NULL,"dec hx"},
	{0,4,3,0,0,0,&dd26,NULL,"ld hx,:1"},
	{0,4,0,0,0,0,&npr27,NULL,"daa"},

	{0,4,3,5,0,0,&npr28,NULL,"jr z,:3"},
	{0,11,0,0,0,0,&dd29,NULL,"add ix,ix"},
	{0,4,3,3,3,3,&dd2A,NULL,"ld ix,(:2)"},		// 4,3rd,3rd,3rd,3rd
	{0,6,0,0,0,0,&dd2B,NULL,"dec ix"},
	{0,4,0,0,0,0,&dd2C,NULL,"inc lx"},
	{0,4,0,0,0,0,&dd2D,NULL,"dec lx"},
	{0,4,3,0,0,0,&dd2E,NULL,"ld lx,:1"},
	...
	{0,4,3,4,0,0,&dd34,NULL,"inc (ix:4)"},
	{0,4,3,4,0,0,&dd35,NULL,"dec (ix:4)"},
	{0,4,3,3,0,0,&dd36,NULL,"ld (ix:4),:1"},
	{0,4,0,0,0,0,&npr37,NULL,"scf"},

	{0,4,3,5,0,0,&npr38,NULL,"jr c,:3"},
	{0,11,0,0,0,0,&dd39,NULL,"add ix,sp"},
	...
	{0,4,0,0,0,0,&dd44,NULL,"ld b,hx"},
	{0,4,0,0,0,0,&dd45,NULL,"ld b,lx"},
	{0,4,3,0,0,0,&dd46,NULL,"ld b,(ix:4)"},
	...
	{0,4,0,0,0,0,&dd4C,NULL,"ld c,hx"},
	{0,4,0,0,0,0,&dd4D,NULL,"ld c,lx"},
	{0,4,3,0,0,0,&dd4E,NULL,"ld c,(ix:4)"},
	...
	{0,4,0,0,0,0,&dd54,NULL,"ld d,hx"},
	{0,4,0,0,0,0,&dd55,NULL,"ld d,lx"},
	{0,4,3,0,0,0,&dd56,NULL,"ld d,(ix:4)"},
	...
	{0,4,0,0,0,0,&dd5C,NULL,"ld e,hx"},
	{0,4,0,0,0,0,&dd5D,NULL,"ld e,lx"},
	{0,4,3,0,0,0,&dd5E,NULL,"ld e,(ix:4)"},
	{0,4,0,0,0,0,&npr5F,NULL,"ld e,a"},

	{0,4,0,0,0,0,&dd60,NULL,"ld hx,b"},
	{0,4,0,0,0,0,&dd61,NULL,"ld hx,c"},
	{0,4,0,0,0,0,&dd62,NULL,"ld hx,d"},
	{0,4,0,0,0,0,&dd63,NULL,"ld hx,e"},
	{0,4,0,0,0,0,&dd64,NULL,"ld hx,hx"},
	{0,4,0,0,0,0,&dd65,NULL,"ld hx,lx"},
	{0,4,3,0,0,0,&dd66,NULL,"ld h,(ix:4)"},
	{0,4,0,0,0,0,&dd67,NULL,"ld hx,a"},

	{0,4,0,0,0,0,&dd68,NULL,"ld lx,b"},
	{0,4,0,0,0,0,&dd69,NULL,"ld lx,c"},
	{0,4,0,0,0,0,&dd6A,NULL,"ld lx,d"},
	{0,4,0,0,0,0,&dd6B,NULL,"ld lx,e"},
	{0,4,0,0,0,0,&dd6C,NULL,"ld lx,hx"},
	{0,4,0,0,0,0,&dd6D,NULL,"ld lx,lx"},
	{0,4,3,0,0,0,&dd6E,NULL,"ld l,(ix:4)"},
	{0,4,0,0,0,0,&dd6F,NULL,"ld lx,a"},

	{0,4,3,0,0,0,&dd70,NULL,"ld (ix:4),b"},
	{0,4,3,0,0,0,&dd71,NULL,"ld (ix:4),c"},
	{0,4,3,0,0,0,&dd72,NULL,"ld (ix:4),d"},
	{0,4,3,0,0,0,&dd73,NULL,"ld (ix:4),e"},
	{0,4,3,0,0,0,&dd74,NULL,"ld (ix:4),h"},
	{0,4,3,0,0,0,&dd75,NULL,"ld (ix:4),l"},
	{0,4,0,0,0,0,&npr76,NULL,"halt"},
	{0,4,3,0,0,0,&dd77,NULL,"ld (ix:4),a"},

	{0,4,0,0,0,0,&npr78,NULL,"ld a,b"},
	{0,4,0,0,0,0,&npr79,NULL,"ld a,c"},
	{0,4,0,0,0,0,&npr7A,NULL,"ld a,d"},
	{0,4,0,0,0,0,&npr7B,NULL,"ld a,e"},
	{0,4,0,0,0,0,&dd7C,NULL,"ld a,hx"},
	{0,4,0,0,0,0,&dd7D,NULL,"ld a,lx"},
	{0,4,3,0,0,0,&dd7E,NULL,"ld a,(ix:4)"},
	...
	{0,4,0,0,0,0,&dd84,NULL,"add a,hx"},
	{0,4,0,0,0,0,&dd85,NULL,"add a,lx"},
	{0,4,3,0,0,0,&dd86,NULL,"add a,(ix:4)"},
	...
	{0,4,0,0,0,0,&dd8C,NULL,"adc a,hx"},
	{0,4,0,0,0,0,&dd8D,NULL,"adc a,lx"},
	{0,4,3,0,0,0,&dd8E,NULL,"adc a,(ix:4)"},
	...
	{0,4,0,0,0,0,&dd94,NULL,"sub hx"},
	{0,4,0,0,0,0,&dd95,NULL,"sub lx"},
	{0,4,3,0,0,0,&dd96,NULL,"sub (ix:4)"},
	...
	{0,4,0,0,0,0,&dd9C,NULL,"sbc a,hx"},
	{0,4,0,0,0,0,&dd9D,NULL,"sbc a,lx"},
	{0,4,3,0,0,0,&dd9E,NULL,"sbc a,(ix:4)"},
	...
	{0,4,0,0,0,0,&ddA4,NULL,"and hx"},
	{0,4,0,0,0,0,&ddA5,NULL,"and lx"},
	{0,4,3,0,0,0,&ddA6,NULL,"and (ix:4)"},
	...
	{0,4,0,0,0,0,&ddAC,NULL,"xor hx"},
	{0,4,0,0,0,0,&ddAD,NULL,"xor lx"},
	{0,4,3,0,0,0,&ddAE,NULL,"xor (ix:4)"},
	...
	{0,4,0,0,0,0,&ddB4,NULL,"or hx"},
	{0,4,0,0,0,0,&ddB5,NULL,"or lx"},
	{0,4,3,0,0,0,&ddB6,NULL,"or (ix:4)"},
	...
	{0,4,0,0,0,0,&ddBC,NULL,"cp hx"},
	{0,4,0,0,0,0,&ddBD,NULL,"cp lx"},
	{0,4,3,0,0,0,&ddBE,NULL,"cp (ix:4)"},
	...
	{0,6,0,0,0,0,&ddF9,NULL,"ld sp,ix"},
