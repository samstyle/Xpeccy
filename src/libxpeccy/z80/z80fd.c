...
opCode fdTab[256]={
	...
	{0,11,0,0,0,0,0,&fd09,NULL,"add iy,bc"},
	...
	{0,11,0,0,0,0,0,&fd19,NULL,"add iy,de"},
	...
	{0,4,3,3,0,0,0,&fd21,NULL,"ld iy,:2"},
	{0,4,3,3,3,3,0,&fd22,NULL,"ld (:2),iy"},		// 4,3rd,3rd,3wr,3wr
	{0,6,0,0,0,0,0,&fd23,NULL,"inc iy"},
	{0,4,0,0,0,0,0,&fd24,NULL,"inc hy"},
	{0,4,0,0,0,0,0,&fd25,NULL,"dec hy"},
	{0,4,3,0,0,0,0,&fd26,NULL,"ld hy,:1"},
	{0,4,0,0,0,0,0,&npr27,NULL,"daa"},

	{0,4,3,5,0,0,0,&npr28,NULL,"jr z,:3"},
	{0,11,0,0,0,0,0,&fd29,NULL,"add iy,iy"},
	{0,4,3,3,3,3,0,&fd2A,NULL,"ld iy,(:2)"},		// 4,3rd,3rd,3rd,3rd
	{0,6,0,0,0,0,0,&fd2B,NULL,"dec iy"},
	{0,4,0,0,0,0,0,&fd2C,NULL,"inc ly"},
	{0,4,0,0,0,0,0,&fd2D,NULL,"dec ly"},
	{0,4,3,0,0,0,0,&fd2E,NULL,"ld ly,:1"},
	...
	{0,4,3,4,0,0,0,&fd34,NULL,"inc (iy:4)"},
	{0,4,3,4,0,0,0,&fd35,NULL,"dec (iy:4)"},
	{0,4,3,3,0,0,0,&fd36,NULL,"ld (iy:4),:1"},
	{0,4,0,0,0,0,0,&npr37,NULL,"scf"},

	{0,4,3,5,0,0,0,&npr38,NULL,"jr c,:3"},
	{0,11,0,0,0,0,0,&fd39,NULL,"add iy,sp"},
	...
	{0,4,0,0,0,0,0,&fd44,NULL,"ld b,hy"},
	{0,4,0,0,0,0,0,&fd45,NULL,"ld b,ly"},
	{0,4,3,0,0,0,0,&fd46,NULL,"ld b,(iy:4)"},
	...
	{0,4,0,0,0,0,0,&fd4C,NULL,"ld c,hy"},
	{0,4,0,0,0,0,0,&fd4D,NULL,"ld c,ly"},
	{0,4,3,0,0,0,0,&fd4E,NULL,"ld c,(iy:4)"},
	...
	{0,4,0,0,0,0,0,&fd54,NULL,"ld d,hy"},
	{0,4,0,0,0,0,0,&fd55,NULL,"ld d,ly"},
	{0,4,3,0,0,0,0,&fd56,NULL,"ld d,(iy:4)"},
	...
	{0,4,0,0,0,0,0,&fd5C,NULL,"ld e,hy"},
	{0,4,0,0,0,0,0,&fd5D,NULL,"ld e,ly"},
	{0,4,3,0,0,0,0,&fd5E,NULL,"ld e,(iy:4)"},
	{0,4,0,0,0,0,0,&npr5F,NULL,"ld e,a"},

	{0,4,0,0,0,0,0,&fd60,NULL,"ld hy,b"},
	{0,4,0,0,0,0,0,&fd61,NULL,"ld hy,c"},
	{0,4,0,0,0,0,0,&fd62,NULL,"ld hy,d"},
	{0,4,0,0,0,0,0,&fd63,NULL,"ld hy,e"},
	{0,4,0,0,0,0,0,&fd64,NULL,"ld hy,hy"},
	{0,4,0,0,0,0,0,&fd65,NULL,"ld hy,ly"},
	{0,4,3,0,0,0,0,&fd66,NULL,"ld h,(iy:4)"},
	{0,4,0,0,0,0,0,&fd67,NULL,"ld hy,a"},

	{0,4,0,0,0,0,0,&fd68,NULL,"ld ly,b"},
	{0,4,0,0,0,0,0,&fd69,NULL,"ld ly,c"},
	{0,4,0,0,0,0,0,&fd6A,NULL,"ld ly,d"},
	{0,4,0,0,0,0,0,&fd6B,NULL,"ld ly,e"},
	{0,4,0,0,0,0,0,&fd6C,NULL,"ld ly,hy"},
	{0,4,0,0,0,0,0,&fd6D,NULL,"ld ly,ly"},
	{0,4,3,0,0,0,0,&fd6E,NULL,"ld l,(iy:4)"},
	{0,4,0,0,0,0,0,&fd6F,NULL,"ld ly,a"},

	{0,4,3,0,0,0,0,&fd70,NULL,"ld (iy:4),b"},
	{0,4,3,0,0,0,0,&fd71,NULL,"ld (iy:4),c"},
	{0,4,3,0,0,0,0,&fd72,NULL,"ld (iy:4),d"},
	{0,4,3,0,0,0,0,&fd73,NULL,"ld (iy:4),e"},
	{0,4,3,0,0,0,0,&fd74,NULL,"ld (iy:4),h"},
	{0,4,3,0,0,0,0,&fd75,NULL,"ld (iy:4),l"},
	{0,4,0,0,0,0,0,&npr76,NULL,"halt"},
	{0,4,3,0,0,0,0,&fd77,NULL,"ld (iy:4),a"},
	...
	{0,4,0,0,0,0,0,&fd7C,NULL,"ld a,hy"},
	{0,4,0,0,0,0,0,&fd7D,NULL,"ld a,ly"},
	{0,4,3,0,0,0,0,&fd7E,NULL,"ld a,(iy:4)"},
	...
	{0,4,0,0,0,0,0,&fd84,NULL,"add a,hy"},
	{0,4,0,0,0,0,0,&fd85,NULL,"add a,ly"},
	{0,4,3,0,0,0,0,&fd86,NULL,"add a,(iy:4)"},
	...
	{0,4,0,0,0,0,0,&fd8C,NULL,"adc a,hy"},
	{0,4,0,0,0,0,0,&fd8D,NULL,"adc a,ly"},
	{0,4,3,0,0,0,0,&fd8E,NULL,"adc a,(iy:4)"},
	...
	{0,4,0,0,0,0,0,&fd94,NULL,"sub hy"},
	{0,4,0,0,0,0,0,&fd95,NULL,"sub ly"},
	{0,4,3,0,0,0,0,&fd96,NULL,"sub (iy:4)"},
	...
	{0,4,0,0,0,0,0,&fd9C,NULL,"sbc a,hy"},
	{0,4,0,0,0,0,0,&fd9D,NULL,"sbc a,ly"},
	{0,4,3,0,0,0,0,&fd9E,NULL,"sbc a,(iy:4)"},
	...
	{0,4,0,0,0,0,0,&fdA4,NULL,"and hy"},
	{0,4,0,0,0,0,0,&fdA5,NULL,"and ly"},
	{0,4,3,0,0,0,0,&fdA6,NULL,"and (iy:4)"},
	...
	{0,4,0,0,0,0,0,&fdAC,NULL,"xor hy"},
	{0,4,0,0,0,0,0,&fdAD,NULL,"xor ly"},
	{0,4,3,0,0,0,0,&fdAE,NULL,"xor (iy:4)"},
	...
	{0,4,0,0,0,0,0,&fdB4,NULL,"or hy"},
	{0,4,0,0,0,0,0,&fdB5,NULL,"or ly"},
	{0,4,3,0,0,0,0,&fdB6,NULL,"or (iy:4)"},
	...
	{0,4,0,0,0,0,0,&fdBC,NULL,"cp hy"},
	{0,4,0,0,0,0,0,&fdBD,NULL,"cp ly"},
	{0,4,3,0,0,0,0,&fdBE,NULL,"cp (iy:4)"},
	...
	{0,6,0,0,0,0,0,&fdF9,NULL,"ld sp,iy"},
