...
opCode cbTab[256]={
	{0,4,0,0,0,0,0,&cb00,NULL,"rlc b"},
	{0,4,0,0,0,0,0,&cb01,NULL,"rlc c"},
	{0,4,0,0,0,0,0,&cb02,NULL,"rlc d"},
	{0,4,0,0,0,0,0,&cb03,NULL,"rlc e"},
	{0,4,0,0,0,0,0,&cb04,NULL,"rlc h"},
	{0,4,0,0,0,0,0,&cb05,NULL,"rlc l"},
	{0,4,4,3,0,0,0,&cb06,NULL,"rlc (hl)"},
	{0,4,0,0,0,0,0,&cb07,NULL,"rlc a"},

	{0,4,0,0,0,0,0,&cb08,NULL,"rrc b"},
	{0,4,0,0,0,0,0,&cb09,NULL,"rrc c"},
	{0,4,0,0,0,0,0,&cb0A,NULL,"rrc d"},
	{0,4,0,0,0,0,0,&cb0B,NULL,"rrc e"},
	{0,4,0,0,0,0,0,&cb0C,NULL,"rrc h"},
	{0,4,0,0,0,0,0,&cb0D,NULL,"rrc l"},
	{0,4,4,3,0,0,0,&cb0E,NULL,"rrc (hl)"},
	{0,4,0,0,0,0,0,&cb0F,NULL,"rrc a"},

	{0,4,0,0,0,0,0,&cb10,NULL,"rl b"},
	{0,4,0,0,0,0,0,&cb11,NULL,"rl c"},
	{0,4,0,0,0,0,0,&cb12,NULL,"rl d"},
	{0,4,0,0,0,0,0,&cb13,NULL,"rl e"},
	{0,4,0,0,0,0,0,&cb14,NULL,"rl h"},
	{0,4,0,0,0,0,0,&cb15,NULL,"rl l"},
	{0,4,4,3,0,0,0,&cb16,NULL,"rl (hl)"},
	{0,4,0,0,0,0,0,&cb17,NULL,"rl a"},

	{0,4,0,0,0,0,0,&cb18,NULL,"rr b"},
	{0,4,0,0,0,0,0,&cb19,NULL,"rr c"},
	{0,4,0,0,0,0,0,&cb1A,NULL,"rr d"},
	{0,4,0,0,0,0,0,&cb1B,NULL,"rr e"},
	{0,4,0,0,0,0,0,&cb1C,NULL,"rr h"},
	{0,4,0,0,0,0,0,&cb1D,NULL,"rr l"},
	{0,4,4,3,0,0,0,&cb1E,NULL,"rr (hl)"},
	{0,4,0,0,0,0,0,&cb1F,NULL,"rr a"},

	{0,4,0,0,0,0,0,&cb20,NULL,"sla b"},
	{0,4,0,0,0,0,0,&cb21,NULL,"sla c"},
	{0,4,0,0,0,0,0,&cb22,NULL,"sla d"},
	{0,4,0,0,0,0,0,&cb23,NULL,"sla e"},
	{0,4,0,0,0,0,0,&cb24,NULL,"sla h"},
	{0,4,0,0,0,0,0,&cb25,NULL,"sla l"},
	{0,4,4,3,0,0,0,&cb26,NULL,"sla (hl)"},
	{0,4,0,0,0,0,0,&cb27,NULL,"sla a"},

	{0,4,0,0,0,0,0,&cb28,NULL,"sra b"},
	{0,4,0,0,0,0,0,&cb29,NULL,"sra c"},
	{0,4,0,0,0,0,0,&cb2A,NULL,"sra d"},
	{0,4,0,0,0,0,0,&cb2B,NULL,"sra e"},
	{0,4,0,0,0,0,0,&cb2C,NULL,"sra h"},
	{0,4,0,0,0,0,0,&cb2D,NULL,"sra l"},
	{0,4,4,3,0,0,0,&cb2E,NULL,"sra (hl)"},
	{0,4,0,0,0,0,0,&cb2F,NULL,"sra a"},

	{0,4,0,0,0,0,0,&cb30,NULL,"sll b"},
	{0,4,0,0,0,0,0,&cb31,NULL,"sll c"},
	{0,4,0,0,0,0,0,&cb32,NULL,"sll d"},
	{0,4,0,0,0,0,0,&cb33,NULL,"sll e"},
	{0,4,0,0,0,0,0,&cb34,NULL,"sll h"},
	{0,4,0,0,0,0,0,&cb35,NULL,"sll l"},
	{0,4,4,3,0,0,0,&cb36,NULL,"sll (hl)"},
	{0,4,0,0,0,0,0,&cb37,NULL,"sll a"},

	{0,4,0,0,0,0,0,&cb38,NULL,"srl b"},
	{0,4,0,0,0,0,0,&cb39,NULL,"srl c"},
	{0,4,0,0,0,0,0,&cb3A,NULL,"srl d"},
	{0,4,0,0,0,0,0,&cb3B,NULL,"srl e"},
	{0,4,0,0,0,0,0,&cb3C,NULL,"srl h"},
	{0,4,0,0,0,0,0,&cb3D,NULL,"srl l"},
	{0,4,4,3,0,0,0,&cb3E,NULL,"srl (hl)"},
	{0,4,0,0,0,0,0,&cb3F,NULL,"srl a"},

	{0,4,0,0,0,0,0,&cb40,NULL,"bit 0,b"},
	{0,4,0,0,0,0,0,&cb41,NULL,"bit 0,c"},
	{0,4,0,0,0,0,0,&cb42,NULL,"bit 0,d"},
	{0,4,0,0,0,0,0,&cb43,NULL,"bit 0,e"},
	{0,4,0,0,0,0,0,&cb44,NULL,"bit 0,h"},
	{0,4,0,0,0,0,0,&cb45,NULL,"bit 0,l"},
	{0,4,4,0,0,0,0,&cb46,NULL,"bit 0,(hl)"},
	{0,4,0,0,0,0,0,&cb47,NULL,"bit 0,a"},

	{0,4,0,0,0,0,0,&cb48,NULL,"bit 1,b"},
	{0,4,0,0,0,0,0,&cb49,NULL,"bit 1,c"},
	{0,4,0,0,0,0,0,&cb4A,NULL,"bit 1,d"},
	{0,4,0,0,0,0,0,&cb4B,NULL,"bit 1,e"},
	{0,4,0,0,0,0,0,&cb4C,NULL,"bit 1,h"},
	{0,4,0,0,0,0,0,&cb4D,NULL,"bit 1,l"},
	{0,4,4,0,0,0,0,&cb4E,NULL,"bit 1,(hl)"},
	{0,4,0,0,0,0,0,&cb4F,NULL,"bit 1,a"},

	{0,4,0,0,0,0,0,&cb50,NULL,"bit 2,b"},
	{0,4,0,0,0,0,0,&cb51,NULL,"bit 2,c"},
	{0,4,0,0,0,0,0,&cb52,NULL,"bit 2,d"},
	{0,4,0,0,0,0,0,&cb53,NULL,"bit 2,e"},
	{0,4,0,0,0,0,0,&cb54,NULL,"bit 2,h"},
	{0,4,0,0,0,0,0,&cb55,NULL,"bit 2,l"},
	{0,4,4,0,0,0,0,&cb56,NULL,"bit 2,(hl)"},
	{0,4,0,0,0,0,0,&cb57,NULL,"bit 2,a"},

	{0,4,0,0,0,0,0,&cb58,NULL,"bit 3,b"},
	{0,4,0,0,0,0,0,&cb59,NULL,"bit 3,c"},
	{0,4,0,0,0,0,0,&cb5A,NULL,"bit 3,d"},
	{0,4,0,0,0,0,0,&cb5B,NULL,"bit 3,e"},
	{0,4,0,0,0,0,0,&cb5C,NULL,"bit 3,h"},
	{0,4,0,0,0,0,0,&cb5D,NULL,"bit 3,l"},
	{0,4,4,0,0,0,0,&cb5E,NULL,"bit 3,(hl)"},
	{0,4,0,0,0,0,0,&cb5F,NULL,"bit 3,a"},

	{0,4,0,0,0,0,0,&cb60,NULL,"bit 4,b"},
	{0,4,0,0,0,0,0,&cb61,NULL,"bit 4,c"},
	{0,4,0,0,0,0,0,&cb62,NULL,"bit 4,d"},
	{0,4,0,0,0,0,0,&cb63,NULL,"bit 4,e"},
	{0,4,0,0,0,0,0,&cb64,NULL,"bit 4,h"},
	{0,4,0,0,0,0,0,&cb65,NULL,"bit 4,l"},
	{0,4,4,0,0,0,0,&cb66,NULL,"bit 4,(hl)"},
	{0,4,0,0,0,0,0,&cb67,NULL,"bit 4,a"},

	{0,4,0,0,0,0,0,&cb68,NULL,"bit 5,b"},
	{0,4,0,0,0,0,0,&cb69,NULL,"bit 5,c"},
	{0,4,0,0,0,0,0,&cb6A,NULL,"bit 5,d"},
	{0,4,0,0,0,0,0,&cb6B,NULL,"bit 5,e"},
	{0,4,0,0,0,0,0,&cb6C,NULL,"bit 5,h"},
	{0,4,0,0,0,0,0,&cb6D,NULL,"bit 5,l"},
	{0,4,4,0,0,0,0,&cb6E,NULL,"bit 5,(hl)"},
	{0,4,0,0,0,0,0,&cb6F,NULL,"bit 5,a"},

	{0,4,0,0,0,0,0,&cb70,NULL,"bit 6,b"},
	{0,4,0,0,0,0,0,&cb71,NULL,"bit 6,c"},
	{0,4,0,0,0,0,0,&cb72,NULL,"bit 6,d"},
	{0,4,0,0,0,0,0,&cb73,NULL,"bit 6,e"},
	{0,4,0,0,0,0,0,&cb74,NULL,"bit 6,h"},
	{0,4,0,0,0,0,0,&cb75,NULL,"bit 6,l"},
	{0,4,4,0,0,0,0,&cb76,NULL,"bit 6,(hl)"},
	{0,4,0,0,0,0,0,&cb77,NULL,"bit 6,a"},

	{0,4,0,0,0,0,0,&cb78,NULL,"bit 7,b"},
	{0,4,0,0,0,0,0,&cb79,NULL,"bit 7,c"},
	{0,4,0,0,0,0,0,&cb7A,NULL,"bit 7,d"},
	{0,4,0,0,0,0,0,&cb7B,NULL,"bit 7,e"},
	{0,4,0,0,0,0,0,&cb7C,NULL,"bit 7,h"},
	{0,4,0,0,0,0,0,&cb7D,NULL,"bit 7,l"},
	{0,4,4,0,0,0,0,&cb7E,NULL,"bit 7,(hl)"},
	{0,4,0,0,0,0,0,&cb7F,NULL,"bit 7,a"},

	{0,4,0,0,0,0,0,&cb80,NULL,"res 0,b"},
	{0,4,0,0,0,0,0,&cb81,NULL,"res 0,c"},
	{0,4,0,0,0,0,0,&cb82,NULL,"res 0,d"},
	{0,4,0,0,0,0,0,&cb83,NULL,"res 0,e"},
	{0,4,0,0,0,0,0,&cb84,NULL,"res 0,h"},
	{0,4,0,0,0,0,0,&cb85,NULL,"res 0,l"},
	{0,4,4,3,0,0,0,&cb86,NULL,"res 0,(hl)"},
	{0,4,0,0,0,0,0,&cb87,NULL,"res 0,a"},

	{0,4,0,0,0,0,0,&cb88,NULL,"res 1,b"},
	{0,4,0,0,0,0,0,&cb89,NULL,"res 1,c"},
	{0,4,0,0,0,0,0,&cb8A,NULL,"res 1,d"},
	{0,4,0,0,0,0,0,&cb8B,NULL,"res 1,e"},
	{0,4,0,0,0,0,0,&cb8C,NULL,"res 1,h"},
	{0,4,0,0,0,0,0,&cb8D,NULL,"res 1,l"},
	{0,4,4,3,0,0,0,&cb8E,NULL,"res 1,(hl)"},
	{0,4,0,0,0,0,0,&cb8F,NULL,"res 1,a"},

	{0,4,0,0,0,0,0,&cb90,NULL,"res 2,b"},
	{0,4,0,0,0,0,0,&cb91,NULL,"res 2,c"},
	{0,4,0,0,0,0,0,&cb92,NULL,"res 2,d"},
	{0,4,0,0,0,0,0,&cb93,NULL,"res 2,e"},
	{0,4,0,0,0,0,0,&cb94,NULL,"res 2,h"},
	{0,4,0,0,0,0,0,&cb95,NULL,"res 2,l"},
	{0,4,4,3,0,0,0,&cb96,NULL,"res 2,(hl)"},
	{0,4,0,0,0,0,0,&cb97,NULL,"res 2,a"},

	{0,4,0,0,0,0,0,&cb98,NULL,"res 3,b"},
	{0,4,0,0,0,0,0,&cb99,NULL,"res 3,c"},
	{0,4,0,0,0,0,0,&cb9A,NULL,"res 3,d"},
	{0,4,0,0,0,0,0,&cb9B,NULL,"res 3,e"},
	{0,4,0,0,0,0,0,&cb9C,NULL,"res 3,h"},
	{0,4,0,0,0,0,0,&cb9D,NULL,"res 3,l"},
	{0,4,4,3,0,0,0,&cb9E,NULL,"res 3,(hl)"},
	{0,4,0,0,0,0,0,&cb9F,NULL,"res 3,a"},

	{0,4,0,0,0,0,0,&cbA0,NULL,"res 4,b"},
	{0,4,0,0,0,0,0,&cbA1,NULL,"res 4,c"},
	{0,4,0,0,0,0,0,&cbA2,NULL,"res 4,d"},
	{0,4,0,0,0,0,0,&cbA3,NULL,"res 4,e"},
	{0,4,0,0,0,0,0,&cbA4,NULL,"res 4,h"},
	{0,4,0,0,0,0,0,&cbA5,NULL,"res 4,l"},
	{0,4,4,3,0,0,0,&cbA6,NULL,"res 4,(hl)"},
	{0,4,0,0,0,0,0,&cbA7,NULL,"res 4,a"},

	{0,4,0,0,0,0,0,&cbA8,NULL,"res 5,b"},
	{0,4,0,0,0,0,0,&cbA9,NULL,"res 5,c"},
	{0,4,0,0,0,0,0,&cbAA,NULL,"res 5,d"},
	{0,4,0,0,0,0,0,&cbAB,NULL,"res 5,e"},
	{0,4,0,0,0,0,0,&cbAC,NULL,"res 5,h"},
	{0,4,0,0,0,0,0,&cbAD,NULL,"res 5,l"},
	{0,4,4,3,0,0,0,&cbAE,NULL,"res 5,(hl)"},
	{0,4,0,0,0,0,0,&cbAF,NULL,"res 5,a"},

	{0,4,0,0,0,0,0,&cbB0,NULL,"res 6,b"},
	{0,4,0,0,0,0,0,&cbB1,NULL,"res 6,c"},
	{0,4,0,0,0,0,0,&cbB2,NULL,"res 6,d"},
	{0,4,0,0,0,0,0,&cbB3,NULL,"res 6,e"},
	{0,4,0,0,0,0,0,&cbB4,NULL,"res 6,h"},
	{0,4,0,0,0,0,0,&cbB5,NULL,"res 6,l"},
	{0,4,4,3,0,0,0,&cbB6,NULL,"res 6,(hl)"},
	{0,4,0,0,0,0,0,&cbB7,NULL,"res 6,a"},

	{0,4,0,0,0,0,0,&cbB8,NULL,"res 7,b"},
	{0,4,0,0,0,0,0,&cbB9,NULL,"res 7,c"},
	{0,4,0,0,0,0,0,&cbBA,NULL,"res 7,d"},
	{0,4,0,0,0,0,0,&cbBB,NULL,"res 7,e"},
	{0,4,0,0,0,0,0,&cbBC,NULL,"res 7,h"},
	{0,4,0,0,0,0,0,&cbBD,NULL,"res 7,l"},
	{0,4,4,3,0,0,0,&cbBE,NULL,"res 7,(hl)"},
	{0,4,0,0,0,0,0,&cbBF,NULL,"res 7,a"},

	{0,4,0,0,0,0,0,&cbC0,NULL,"set 0,b"},
	{0,4,0,0,0,0,0,&cbC1,NULL,"set 0,c"},
	{0,4,0,0,0,0,0,&cbC2,NULL,"set 0,d"},
	{0,4,0,0,0,0,0,&cbC3,NULL,"set 0,e"},
	{0,4,0,0,0,0,0,&cbC4,NULL,"set 0,h"},
	{0,4,0,0,0,0,0,&cbC5,NULL,"set 0,l"},
	{0,4,4,3,0,0,0,&cbC6,NULL,"set 0,(hl)"},
	{0,4,0,0,0,0,0,&cbC7,NULL,"set 0,a"},

	{0,4,0,0,0,0,0,&cbC8,NULL,"set 1,b"},
	{0,4,0,0,0,0,0,&cbC9,NULL,"set 1,c"},
	{0,4,0,0,0,0,0,&cbCA,NULL,"set 1,d"},
	{0,4,0,0,0,0,0,&cbCB,NULL,"set 1,e"},
	{0,4,0,0,0,0,0,&cbCC,NULL,"set 1,h"},
	{0,4,0,0,0,0,0,&cbCD,NULL,"set 1,l"},
	{0,4,4,3,0,0,0,&cbCE,NULL,"set 1,(hl)"},
	{0,4,0,0,0,0,0,&cbCF,NULL,"set 1,a"},

	{0,4,0,0,0,0,0,&cbD0,NULL,"set 2,b"},
	{0,4,0,0,0,0,0,&cbD1,NULL,"set 2,c"},
	{0,4,0,0,0,0,0,&cbD2,NULL,"set 2,d"},
	{0,4,0,0,0,0,0,&cbD3,NULL,"set 2,e"},
	{0,4,0,0,0,0,0,&cbD4,NULL,"set 2,h"},
	{0,4,0,0,0,0,0,&cbD5,NULL,"set 2,l"},
	{0,4,4,3,0,0,0,&cbD6,NULL,"set 2,(hl)"},
	{0,4,0,0,0,0,0,&cbD7,NULL,"set 2,a"},

	{0,4,0,0,0,0,0,&cbD8,NULL,"set 3,b"},
	{0,4,0,0,0,0,0,&cbD9,NULL,"set 3,c"},
	{0,4,0,0,0,0,0,&cbDA,NULL,"set 3,d"},
	{0,4,0,0,0,0,0,&cbDB,NULL,"set 3,e"},
	{0,4,0,0,0,0,0,&cbDC,NULL,"set 3,h"},
	{0,4,0,0,0,0,0,&cbDD,NULL,"set 3,l"},
	{0,4,4,3,0,0,0,&cbDE,NULL,"set 3,(hl)"},
	{0,4,0,0,0,0,0,&cbDF,NULL,"set 3,a"},

	{0,4,0,0,0,0,0,&cbE0,NULL,"set 4,b"},
	{0,4,0,0,0,0,0,&cbE1,NULL,"set 4,c"},
	{0,4,0,0,0,0,0,&cbE2,NULL,"set 4,d"},
	{0,4,0,0,0,0,0,&cbE3,NULL,"set 4,e"},
	{0,4,0,0,0,0,0,&cbE4,NULL,"set 4,h"},
	{0,4,0,0,0,0,0,&cbE5,NULL,"set 4,l"},
	{0,4,4,3,0,0,0,&cbE6,NULL,"set 4,(hl)"},
	{0,4,0,0,0,0,0,&cbE7,NULL,"set 4,a"},

	{0,4,0,0,0,0,0,&cbE8,NULL,"set 5,b"},
	{0,4,0,0,0,0,0,&cbE9,NULL,"set 5,c"},
	{0,4,0,0,0,0,0,&cbEA,NULL,"set 5,d"},
	{0,4,0,0,0,0,0,&cbEB,NULL,"set 5,e"},
	{0,4,0,0,0,0,0,&cbEC,NULL,"set 5,h"},
	{0,4,0,0,0,0,0,&cbED,NULL,"set 5,l"},
	{0,4,4,3,0,0,0,&cbEE,NULL,"set 5,(hl)"},
	{0,4,0,0,0,0,0,&cbEF,NULL,"set 5,a"},

	{0,4,0,0,0,0,0,&cbF0,NULL,"set 6,b"},
	{0,4,0,0,0,0,0,&cbF1,NULL,"set 6,c"},
	{0,4,0,0,0,0,0,&cbF2,NULL,"set 6,d"},
	{0,4,0,0,0,0,0,&cbF3,NULL,"set 6,e"},
	{0,4,0,0,0,0,0,&cbF4,NULL,"set 6,h"},
	{0,4,0,0,0,0,0,&cbF5,NULL,"set 6,l"},
	{0,4,4,3,0,0,0,&cbF6,NULL,"set 6,(hl)"},
	{0,4,0,0,0,0,0,&cbF7,NULL,"set 6,a"},

	{0,4,0,0,0,0,0,&cbF8,NULL,"set 7,b"},
	{0,4,0,0,0,0,0,&cbF9,NULL,"set 7,c"},
	{0,4,0,0,0,0,0,&cbFA,NULL,"set 7,d"},
	{0,4,0,0,0,0,0,&cbFB,NULL,"set 7,e"},
	{0,4,0,0,0,0,0,&cbFC,NULL,"set 7,h"},
	{0,4,0,0,0,0,0,&cbFD,NULL,"set 7,l"},
	{0,4,4,3,0,0,0,&cbFE,NULL,"set 7,(hl)"},
	{0,4,0,0,0,0,0,&cbFF,NULL,"set 7,a"},
};
