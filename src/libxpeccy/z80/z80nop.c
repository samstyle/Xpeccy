...
opCode npTab[256]={
	...
	{0,11,0,0,0,0,&npr09,NULL,"add hl,bc"},
	...
	{0,11,0,0,0,0,&npr19,NULL,"add hl,de"},
	...
	{0,4,3,3,0,0,&npr21,NULL,"ld hl,:2"},
	{0,4,3,3,3,3,&npr22,NULL,"ld (:2),hl"},		// 4,3rd,3rd,3wr,3wr
	{0,6,0,0,0,0,&npr23,NULL,"inc hl"},
	{0,4,0,0,0,0,&npr24,NULL,"inc h"},
	{0,4,0,0,0,0,&npr25,NULL,"dec h"},
	{0,4,3,0,0,0,&npr26,NULL,"ld h,:1"},
	{0,4,0,0,0,0,&npr27,NULL,"daa"},

	{0,4,3,5,0,0,&npr28,NULL,"jr z,:3"},
	{0,11,0,0,0,0,&npr29,NULL,"add hl,hl"},
	{0,4,3,3,3,3,&npr2A,NULL,"ld hl,(:2)"},		// 4,3rd,3rd,3rd,3rd
	{0,6,0,0,0,0,&npr2B,NULL,"dec hl"},
	{0,4,0,0,0,0,&npr2C,NULL,"inc l"},
	{0,4,0,0,0,0,&npr2D,NULL,"dec l"},
	{0,4,3,0,0,0,&npr2E,NULL,"ld l,:1"},
	...
	{0,4,3,4,0,0,&npr34,NULL,"inc (hl)"},
	{0,4,3,4,0,0,&npr35,NULL,"dec (hl)"},
	{0,4,3,3,0,0,&npr36,NULL,"ld (hl),:1"},
	{0,4,0,0,0,0,&npr37,NULL,"scf"},

	{0,4,3,5,0,0,&npr38,NULL,"jr c,:3"},
	{0,11,0,0,0,0,&npr39,NULL,"add hl,sp"},
	...
	{0,4,0,0,0,0,&npr44,NULL,"ld b,h"},
	{0,4,0,0,0,0,&npr45,NULL,"ld b,l"},
	{0,4,3,0,0,0,&npr46,NULL,"ld b,(hl)"},
	...
	{0,4,0,0,0,0,&npr4C,NULL,"ld c,h"},
	{0,4,0,0,0,0,&npr4D,NULL,"ld c,l"},
	{0,4,3,0,0,0,&npr4E,NULL,"ld c,(hl)"},
	...
	{0,4,0,0,0,0,&npr54,NULL,"ld d,h"},
	{0,4,0,0,0,0,&npr55,NULL,"ld d,l"},
	{0,4,3,0,0,0,&npr56,NULL,"ld d,(hl)"},
	...
	{0,4,0,0,0,0,&npr5C,NULL,"ld e,h"},
	{0,4,0,0,0,0,&npr5D,NULL,"ld e,l"},
	{0,4,3,0,0,0,&npr5E,NULL,"ld e,(hl)"},
	{0,4,0,0,0,0,&npr5F,NULL,"ld e,a"},

	{0,4,0,0,0,0,&npr60,NULL,"ld h,b"},
	{0,4,0,0,0,0,&npr61,NULL,"ld h,c"},
	{0,4,0,0,0,0,&npr62,NULL,"ld h,d"},
	{0,4,0,0,0,0,&npr63,NULL,"ld h,e"},
	{0,4,0,0,0,0,&npr64,NULL,"ld h,h"},
	{0,4,0,0,0,0,&npr65,NULL,"ld h,l"},
	{0,4,3,0,0,0,&npr66,NULL,"ld h,(hl)"},
	{0,4,0,0,0,0,&npr67,NULL,"ld h,a"},

	{0,4,0,0,0,0,&npr68,NULL,"ld l,b"},
	{0,4,0,0,0,0,&npr69,NULL,"ld l,c"},
	{0,4,0,0,0,0,&npr6A,NULL,"ld l,d"},
	{0,4,0,0,0,0,&npr6B,NULL,"ld l,e"},
	{0,4,0,0,0,0,&npr6C,NULL,"ld l,h"},
	{0,4,0,0,0,0,&npr6D,NULL,"ld l,l"},
	{0,4,3,0,0,0,&npr6E,NULL,"ld l,(hl)"},
	{0,4,0,0,0,0,&npr6F,NULL,"ld l,a"},

	{0,4,3,0,0,0,&npr70,NULL,"ld (hl),b"},
	{0,4,3,0,0,0,&npr71,NULL,"ld (hl),c"},
	{0,4,3,0,0,0,&npr72,NULL,"ld (hl),d"},
	{0,4,3,0,0,0,&npr73,NULL,"ld (hl),e"},
	{0,4,3,0,0,0,&npr74,NULL,"ld (hl),h"},
	{0,4,3,0,0,0,&npr75,NULL,"ld (hl),l"},
	{0,4,0,0,0,0,&npr76,NULL,"halt"},
	{0,4,3,0,0,0,&npr77,NULL,"ld (hl),a"},

	{0,4,0,0,0,0,&npr78,NULL,"ld a,b"},
	{0,4,0,0,0,0,&npr79,NULL,"ld a,c"},
	{0,4,0,0,0,0,&npr7A,NULL,"ld a,d"},
	{0,4,0,0,0,0,&npr7B,NULL,"ld a,e"},
	{0,4,0,0,0,0,&npr7C,NULL,"ld a,h"},
	{0,4,0,0,0,0,&npr7D,NULL,"ld a,l"},
	{0,4,3,0,0,0,&npr7E,NULL,"ld a,(hl)"},
	...
	{0,4,0,0,0,0,&npr84,NULL,"add a,h"},
	{0,4,0,0,0,0,&npr85,NULL,"add a,l"},
	{0,4,3,0,0,0,&npr86,NULL,"add a,(hl)"},
	...
	{0,4,0,0,0,0,&npr8C,NULL,"adc a,h"},
	{0,4,0,0,0,0,&npr8D,NULL,"adc a,l"},
	{0,4,3,0,0,0,&npr8E,NULL,"adc a,(hl)"},
	...
	{0,4,0,0,0,0,&npr94,NULL,"sub h"},
	{0,4,0,0,0,0,&npr95,NULL,"sub l"},
	{0,4,3,0,0,0,&npr96,NULL,"sub (hl)"},
	...
	{0,4,0,0,0,0,&npr9C,NULL,"sbc a,h"},
	{0,4,0,0,0,0,&npr9D,NULL,"sbc a,l"},
	{0,4,3,0,0,0,&npr9E,NULL,"sbc a,(hl)"},
	...
	{0,4,0,0,0,0,&nprA4,NULL,"and h"},
	{0,4,0,0,0,0,&nprA5,NULL,"and l"},
	{0,4,3,0,0,0,&nprA6,NULL,"and (hl)"},
	...
	{0,4,0,0,0,0,&nprAC,NULL,"xor h"},
	{0,4,0,0,0,0,&nprAD,NULL,"xor l"},
	{0,4,3,0,0,0,&nprAE,NULL,"xor (hl)"},
	...
	{0,4,0,0,0,0,&nprB4,NULL,"or h"},
	{0,4,0,0,0,0,&nprB5,NULL,"or l"},
	{0,4,3,0,0,0,&nprB6,NULL,"or (hl)"},
	...
	{0,4,0,0,0,0,&nprBC,NULL,"cp h"},
	{0,4,0,0,0,0,&nprBD,NULL,"cp l"},
	{0,4,3,0,0,0,&nprBE,NULL,"cp (hl)"},
	...
	{0,6,0,0,0,0,&nprF9,NULL,"ld sp,hl"},
