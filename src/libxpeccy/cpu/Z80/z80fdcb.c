...
void fdcb00(CPU* cpu) {XDCBR(cpu->iy,RLC,cpu->b);}
void fdcb01(CPU* cpu) {XDCBR(cpu->iy,RLC,cpu->c);}
void fdcb02(CPU* cpu) {XDCBR(cpu->iy,RLC,cpu->d);}
void fdcb03(CPU* cpu) {XDCBR(cpu->iy,RLC,cpu->e);}
void fdcb04(CPU* cpu) {XDCBR(cpu->iy,RLC,cpu->h);}
void fdcb05(CPU* cpu) {XDCBR(cpu->iy,RLC,cpu->l);}
void fdcb06(CPU* cpu) {XDCB(cpu->iy,RLC);}
void fdcb07(CPU* cpu) {XDCBR(cpu->iy,RLC,cpu->a);}
// rrc reg,(iy+e)
void fdcb08(CPU* cpu) {XDCBR(cpu->iy,RRC,cpu->b);}
void fdcb09(CPU* cpu) {XDCBR(cpu->iy,RRC,cpu->c);}
void fdcb0A(CPU* cpu) {XDCBR(cpu->iy,RRC,cpu->d);}
void fdcb0B(CPU* cpu) {XDCBR(cpu->iy,RRC,cpu->e);}
void fdcb0C(CPU* cpu) {XDCBR(cpu->iy,RRC,cpu->h);}
void fdcb0D(CPU* cpu) {XDCBR(cpu->iy,RRC,cpu->l);}
void fdcb0E(CPU* cpu) {XDCB(cpu->iy,RRC);}
void fdcb0F(CPU* cpu) {XDCBR(cpu->iy,RRC,cpu->a);}
// rl reg,(iy+e)
void fdcb10(CPU* cpu) {XDCBR(cpu->iy,RL,cpu->b);}
void fdcb11(CPU* cpu) {XDCBR(cpu->iy,RL,cpu->c);}
void fdcb12(CPU* cpu) {XDCBR(cpu->iy,RL,cpu->d);}
void fdcb13(CPU* cpu) {XDCBR(cpu->iy,RL,cpu->e);}
void fdcb14(CPU* cpu) {XDCBR(cpu->iy,RL,cpu->h);}
void fdcb15(CPU* cpu) {XDCBR(cpu->iy,RL,cpu->l);}
void fdcb16(CPU* cpu) {XDCB(cpu->iy,RL);}
void fdcb17(CPU* cpu) {XDCBR(cpu->iy,RL,cpu->a);}
// rr reg,(iy+e)
void fdcb18(CPU* cpu) {XDCBR(cpu->iy,RR,cpu->b);}
void fdcb19(CPU* cpu) {XDCBR(cpu->iy,RR,cpu->c);}
void fdcb1A(CPU* cpu) {XDCBR(cpu->iy,RR,cpu->d);}
void fdcb1B(CPU* cpu) {XDCBR(cpu->iy,RR,cpu->e);}
void fdcb1C(CPU* cpu) {XDCBR(cpu->iy,RR,cpu->h);}
void fdcb1D(CPU* cpu) {XDCBR(cpu->iy,RR,cpu->l);}
void fdcb1E(CPU* cpu) {XDCB(cpu->iy,RR);}
void fdcb1F(CPU* cpu) {XDCBR(cpu->iy,RR,cpu->a);}
// sla reg,(iy+e)
void fdcb20(CPU* cpu) {XDCBR(cpu->iy,SLA,cpu->b);}
void fdcb21(CPU* cpu) {XDCBR(cpu->iy,SLA,cpu->c);}
void fdcb22(CPU* cpu) {XDCBR(cpu->iy,SLA,cpu->d);}
void fdcb23(CPU* cpu) {XDCBR(cpu->iy,SLA,cpu->e);}
void fdcb24(CPU* cpu) {XDCBR(cpu->iy,SLA,cpu->h);}
void fdcb25(CPU* cpu) {XDCBR(cpu->iy,SLA,cpu->l);}
void fdcb26(CPU* cpu) {XDCB(cpu->iy,SLA);}
void fdcb27(CPU* cpu) {XDCBR(cpu->iy,SLA,cpu->a);}
// sra reg,(iy+e)
void fdcb28(CPU* cpu) {XDCBR(cpu->iy,SRA,cpu->b);}
void fdcb29(CPU* cpu) {XDCBR(cpu->iy,SRA,cpu->c);}
void fdcb2A(CPU* cpu) {XDCBR(cpu->iy,SRA,cpu->d);}
void fdcb2B(CPU* cpu) {XDCBR(cpu->iy,SRA,cpu->e);}
void fdcb2C(CPU* cpu) {XDCBR(cpu->iy,SRA,cpu->h);}
void fdcb2D(CPU* cpu) {XDCBR(cpu->iy,SRA,cpu->l);}
void fdcb2E(CPU* cpu) {XDCB(cpu->iy,SRA);}
void fdcb2F(CPU* cpu) {XDCBR(cpu->iy,SRA,cpu->a);}
// sll reg,(iy+e)
void fdcb30(CPU* cpu) {XDCBR(cpu->iy,SLL,cpu->b);}
void fdcb31(CPU* cpu) {XDCBR(cpu->iy,SLL,cpu->c);}
void fdcb32(CPU* cpu) {XDCBR(cpu->iy,SLL,cpu->d);}
void fdcb33(CPU* cpu) {XDCBR(cpu->iy,SLL,cpu->e);}
void fdcb34(CPU* cpu) {XDCBR(cpu->iy,SLL,cpu->h);}
void fdcb35(CPU* cpu) {XDCBR(cpu->iy,SLL,cpu->l);}
void fdcb36(CPU* cpu) {XDCB(cpu->iy,SLL);}
void fdcb37(CPU* cpu) {XDCBR(cpu->iy,SLL,cpu->a);}
// srl reg,(iy+e)
void fdcb38(CPU* cpu) {XDCBR(cpu->iy,SRL,cpu->b);}
void fdcb39(CPU* cpu) {XDCBR(cpu->iy,SRL,cpu->c);}
void fdcb3A(CPU* cpu) {XDCBR(cpu->iy,SRL,cpu->d);}
void fdcb3B(CPU* cpu) {XDCBR(cpu->iy,SRL,cpu->e);}
void fdcb3C(CPU* cpu) {XDCBR(cpu->iy,SRL,cpu->h);}
void fdcb3D(CPU* cpu) {XDCBR(cpu->iy,SRL,cpu->l);}
void fdcb3E(CPU* cpu) {XDCB(cpu->iy,SRL);}
void fdcb3F(CPU* cpu) {XDCBR(cpu->iy,SRL,cpu->a);}
