...
void ed40(CPU* cpu) {
	...
	cpu->fz.s = !!(cpu->b & 0x80);
	cpu->fz.z = !cpu->b;
	cpu->fz.f5 = !!(cpu->b & 0x20);
	cpu->fz.h = 0;
	cpu->fz.f3 = !!(cpu->b & 0x08);
	cpu->fz.pv = parity(cpu->b);
	cpu->fz.n = 0;
...
void ed48(CPU* cpu) {
	...
	cpu->fz.s = !!(cpu->c & 0x80);
	cpu->fz.z = !cpu->c;
	cpu->fz.f5 = !!(cpu->c & 0x20);
	cpu->fz.h = 0;
	cpu->fz.f3 = !!(cpu->c & 0x08);
	cpu->fz.pv = parity(cpu->c);
	cpu->fz.n = 0;
}
...
void ed50(CPU* cpu) {
	...
	cpu->fz.s = !!(cpu->d & 0x80);
	cpu->fz.z = !cpu->d;
	cpu->fz.f5 = !!(cpu->d & 0x20);
	cpu->fz.h = 0;
	cpu->fz.f3 = !!(cpu->d & 0x08);
	cpu->fz.pv = parity(cpu->d);
	cpu->fz.n = 0;
}
...
void ed58(CPU* cpu) {
	...
	cpu->fz.s = !!(cpu->e & 0x80);
	cpu->fz.z = !cpu->e;
	cpu->fz.f5 = !!(cpu->e & 0x20);
	cpu->fz.h = 0;
	cpu->fz.f3 = !!(cpu->e & 0x08);
	cpu->fz.pv = parity(cpu->e);
	cpu->fz.n = 0;
}
...
void ed60(CPU* cpu) {
	...
	cpu->fz.s = !!(cpu->h & 0x80);
	cpu->fz.z = !cpu->h;
	cpu->fz.f5 = !!(cpu->h & 0x20);
	cpu->fz.h = 0;
	cpu->fz.f3 = !!(cpu->h & 0x08);
	cpu->fz.pv = parity(cpu->h);
	cpu->fz.n = 0;
}
...
void ed68(CPU* cpu) {
	...
	cpu->fz.s = !!(cpu->l & 0x80);
	cpu->fz.z = !cpu->l;
	cpu->fz.f5 = !!(cpu->l & 0x20);
	cpu->fz.h = 0;
	cpu->fz.f3 = !!(cpu->l & 0x08);
	cpu->fz.pv = parity(cpu->l);
	cpu->fz.n = 0;
}
