...
xRegDsc i286RegTab[] = {
	...
	{I286_AX, "AX", REG_WORD | REG_RDMP, offsetof(CPU, ax)},
	{I286_BX, "BX", REG_WORD | REG_RDMP, offsetof(CPU, bx)},
	{I286_CX, "CX", REG_WORD | REG_RDMP, offsetof(CPU, cx)},
	{I286_DX, "DX", REG_WORD | REG_RDMP, offsetof(CPU, dx)},
