...
// Precalculated conversion table from sRGB to linear index
...
// Precalculated conversion table from linear to sRGB index
// Link: https://en.wikipedia.org/wiki/SRGB
...
// mix prev <size> bytes from <src> to <dst> 50/50 (respecting sRGB colorspace) and copy unmixed <dst> to <src>
