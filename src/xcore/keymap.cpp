...
//	{"keyname",xkeyid,"zxkeys","profiextkeys","msxkeys",{cpmcode,rowscan}(atm),atcode(set2),joybind}
static keyEntry keyMapInit[] = {
	...
	{"RS",XKEY_RSHIFT,{0,0},{0,0},{0,0},{0,0},0x59,0},
	{"RC",XKEY_RCTRL,{0,0},{0,0},{0,0},{0,0},0x14e0,0},
	...
	{"PGUP",XKEY_PGUP,{'C','3'},{'m'|0x80,0},{MSXK_CODE,0},{0x75,0x49},0x7de0,0},
	{"PGDN",XKEY_PGDN,{'C','4'},{'n'|0x80,0},{MSXK_SEL,0},{0x74,0x51},0x7ae0,0},
	...
	{"NLOCK", XKEY_NUMLCK,{0,0},{0,0},{0,0},{0,0},0x77,0},
	{"NSLASH", XKEY_NSLASH,{0,0},{0,0},{0,0},{0,0},0x4ae0,0},
	{"NMUL", XKEY_NMUL,{0,0},{0,0},{0,0},{0,0},0x7c,0},
	{"NMINUS", XKEY_NMINUS,{0,0},{0,0},{0,0},{0,0},0x7b,0},
	{"NPLUS", XKEY_NPLUS,{0,0},{0,0},{0,0},{0,0},0x79,0},
	{"NENT", XKEY_NENTER,{0,0},{0,0},{0,0},{0,0},0x5ae0,0},
	{"NDOT", XKEY_NDOT,{0,0},{0,0},{0,0},{0,0},0x71,0},
	{"N0", XKEY_N0,{0,0},{0,0},{0,0},{0,0},0x70,0},
	{"N1", XKEY_N1,{0,0},{0,0},{0,0},{0,0},0x69,0},
	{"N2", XKEY_N2,{0,0},{0,0},{0,0},{0,0},0x72,0},
	{"N3", XKEY_N3,{0,0},{0,0},{0,0},{0,0},0x7a,0},
	{"N4", XKEY_N4,{0,0},{0,0},{0,0},{0,0},0x6b,0},
	{"N5", XKEY_N5,{0,0},{0,0},{0,0},{0,0},0x73,0},
	{"N6", XKEY_N6,{0,0},{0,0},{0,0},{0,0},0x74,0},
	{"N7", XKEY_N7,{0,0},{0,0},{0,0},{0,0},0x6c,0},
	{"N8", XKEY_N8,{0,0},{0,0},{0,0},{0,0},0x75,0},
	{"N9", XKEY_N9,{0,0},{0,0},{0,0},{0,0},0x7d,0},
